...
public abstract class ArbolBinario<T> implements Coleccion<T> {
    ...
    protected class Vertice implements VerticeArbolBinario<T> {
	    ...
	    return 1 + max(izquierdo.altura(), derecho.altura());
        }

	/**
	 * Regresa el mayor entre dos enteros.
	 * @param a el primer entero a comparar.
	 * @param b el segundo entero a comparar.
	 * @return el entero más grande entre a y b.
	 */
	private int max(int a, int b){
	    ...
	    if (derecho == null)
		return vertice.derecho == null && izquierdo.equals(vertice.izquierdo);
    ...
    @Override public boolean contiene(T elemento) {
        return buscaVertice(raiz, elemento) != null;
    }
    ...
    public VerticeArbolBinario<T> busca(T elemento) {
        return buscaVertice(raiz, elemento);
    }

    /**
     * Busca un elemento y regresa el vértice en el que lo encuentra. Si no lo
     * encuentra regresa<code>null</code>.
     * @param vertice el vértice dentro del cual y en cuyos hijos buscará el elemento.
     * @param elemento el elemento a buscar.
     * @return el vértice que contiene el elemento buscado o <code>null</code> si no
     *         lo encuentra.
     */
	...
	if (elemento.equals(vertice.elemento))
	    return vertice;
	Vertice porI = buscaVertice(vertice.izquierdo, elemento);
	return porI != null ? porI : buscaVertice(vertice.derecho, elemento);
    }
